      ...
      >
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          ...
          <div className="flex items-center space-x-3 rounded-lg bg-white/80 p-4 shadow">
            <Icon icon="ph:thermometer-simple" width="40" height="40" className="text-red-500" />
            <div>
          ...
          {/* PH Level */}
          <div className="flex items-center space-x-3 rounded-lg bg-white/80 p-4 shadow">
            <Icon icon="ph:scales" width="40" height="40" className="text-green-500" />
            <div>
          ...
          {/* Turbidity */}
          <div className="flex items-center space-x-3 rounded-lg bg-white/80 p-4 shadow">
            <Icon icon="ph:sun" width="40" height="40" className="text-orange-500" />
            <div>
